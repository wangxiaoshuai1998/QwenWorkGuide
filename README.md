<p align="center">
  <a href="https://github.com/OWNER/WorkBuddyGuide-DingTalk">
...
<p align="center">
  ...
  <a href="https://github.com/OWNER/WorkBuddyGuide-DingTalk">在线阅读</a> ·
  <a href="https://github.com/OWNER/WorkBuddyGuide-DingTalk/tree/main/docs/cases">社区案例集</a> ·
  <a href="https://github.com/OWNER/WorkBuddyGuide-DingTalk/tree/main/docs/help">帮你解决</a> ·
...
推荐访问 **[OWNER/WorkBuddyGuide-DingTalk](https://github.com/OWNER/WorkBuddyGuide-DingTalk)** 阅读。网站提供完整侧边栏、全文搜索、章节目录、深色模式、流程图和移动端适配。
...
如果你有真实的工作场景，却不知道怎样用 WorkBuddy 完成，可以前往 **[帮你解决](https://github.com/OWNER/WorkBuddyGuide-DingTalk/tree/main/docs/help)** 提交场景问卷。

请在问卷中说明你遇到的问题、目前的处理方式、会用到的资料、期望结果和安全边界。我们会阅读并评估每一份需求；如果需要补充信息，会通过你主动留下的联系方式与你沟通。

具有代表性和复用价值的问题，我们会尝试制作成完整的开源 Case，写清所用 Skill、安装与使用方法、任务描述、操作过程和最终效果，并发布到[社区案例集](https://github.com/OWNER/WorkBuddyGuide-DingTalk/tree/main/docs/cases)，帮助更多遇到类似问题的人。
...
我们优先收集真实、可复现的 WorkBuddy 使用案例。提交 Case 前，请先搜索[社区案例集](https://github.com/OWNER/WorkBuddyGuide-DingTalk/tree/main/docs/cases)和[蓝皮书目录](https://github.com/OWNER/WorkBuddyGuide-DingTalk/tree/main/docs/bluebook)，确认场景或任务没有重复。若目标相同但使用了不同的 Skill、方法或交付形式，请在 PR 中说明差异。
...
完整流程请阅读 [Case 投稿指南](https://github.com/OWNER/WorkBuddyGuide-DingTalk/blob/main/docs/community/case-contributing.md)和[贡献指南](./CONTRIBUTING.md)。准备或提交 PR 后，也可以按网站提示加入 WorkBuddy 共创群，交流选题并获得内容完善建议。

## 目录结构

```text
WorkBuddyGuide-DingTalk
├─ .github/
