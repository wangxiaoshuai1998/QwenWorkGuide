...
# 把经历发给千问办公，直接生成一份好看的简历

## 这个案例解决什么问题

去年秋招时，我用 PPT 一点点排过一份简历。做出来很好看，修改起来却很麻烦。多加一段经历，后面的内容就要跟着移动；文字多了一行，字号、间距和分页也要重新调整。

后来我把这套简历做成 HTML，又整理成了 [Vibe Resume Skill](https://github.com/KevinYoung-Kw/vibe-resume-skill)。把它安装到千问办公以后，写简历就变成了一件很直接的事：发出自己的经历和照片，告诉 AI 想投什么岗位，它会生成完整简历。以后有新经历，继续发给它修改就行。
...
![在千问办公中安装 Vibe Resume Skill](./assets/install-skill.png)

安装完成后，千问办公会提示 Skill 已经可以使用。

![Vibe Resume Skill 安装完成](./assets/skill-ready.png)

Skill 里有 12 套简历模板。可以让千问办公把模板列出来，挑一套自己喜欢的；如果不想选，直接使用默认模板也可以。

![千问办公列出 12 套简历模板](./assets/template-list.png)
...
![把个人经历、照片和目标岗位发给千问办公](./assets/send-resume-materials.png)

千问办公读完材料后，开始整理内容和排版。第一版生成完成时，右侧可以直接预览整份简历，同时还会得到 HTML、PDF 和预览图。

![千问办公生成第一版简历](./assets/first-resume-result.png)

## 第三步：继续修改

第一版的内容已经完整，不过段落之间有些松。我直接告诉千问办公：
...
千问办公在原来的简历上加入新经历，并重新调整了整页间距。修改前后的内容都保留在同一个任务里，不需要重新制作一份简历。
...
如果还没有简历，可以直接把零散经历发给千问办公，让它整理并生成第一版。

如果已经有 Word、PDF 或 HTML 简历，可以把旧简历和新增经历一起发过去，让它在原版上修改。

如果准备投递不同岗位，可以再附上岗位 JD，让千问办公分别调整经历顺序和内容重点。
