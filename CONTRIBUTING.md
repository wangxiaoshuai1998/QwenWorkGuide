...
感谢你愿意一起完善《千问办公绿皮书》。我们希望每次贡献都能帮助读者更快完成一个真实任务，并留下可以验证、复用和迁移的方法。
...
案例集合首页会在构建时自动读取这些目录，不需要手工修改 `docs/cases/index.md`。完整说明见网站的 [Case 投稿指南](https://qwenwork.ink/community/case-contributing)。
