...
2. Submit `https://qwenwork.ink/sitemap.xml`.
...
5. Keep `https://qwenwork.ink` as the only canonical origin. Permanently
   redirect the legacy `*.pages.dev` hostname and `www.qwenwork.ink` to it.
