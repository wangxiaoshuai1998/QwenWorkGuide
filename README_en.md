...
<h1 align="center">QwenWork Greenbook</h1>

<p align="center"><strong>A hands-on Chinese user manual and practical guide for QwenWork</strong></p>

<p align="center">
  English · <a href="./README.md">简体中文</a> ·
  <a href="https://qwenwork.ink/greenbook/">Read Online</a> ·
...
> This is a task-driven field guide, not a rewritten feature manual. The book is organized into four parts: User Manual, Practical Cases, Advanced Use Cases, and Cognition & Methodology — taking you from getting started with QwenWork to mastering AI workflow methodology.

## Background

This project originates from the open-source QwenWork Greenbook ([wangxiaoshuai1998/QwenWorkGuide](https://github.com/wangxiaoshuai1998/QwenWorkGuide)) and has been rebuilt on top of its site framework as the QwenWork Greenbook. The book content is exported from a DingTalk knowledge base and maintained around real QwenWork workflows.

## Read Online

The recommended reading experience is **[qwenwork.ink/greenbook](https://qwenwork.ink/greenbook/)**. The website provides full navigation, local search, page outlines, dark mode, rendered diagrams, and mobile support.
...
The book is organized into four parts, continuously updated:

| Part | Topics |
| --- | --- |
| Part I · User Manual | Getting to know QwenWork, web and desktop workflows, general settings, web and desktop core features, AI concepts (7 chapters) |
| Part II · Practical Cases | Excel data processing, data analysis workflows, document organization and writing, e-commerce dashboards, voice cloning, Remotion video, and more |
| Part III · Advanced Use Cases | WeChat article formatting, content creation workflows, image design and generation, UI to frontend prototype, requirements to prototype, and more |
| Part IV · Cognition & Methodology | AI workflow methodology, how to write a Skill, IP illustration architecture deep-dive, WeChat formatting Skill walkthrough |

## How to Read

- **New to QwenWork**: start with Chapter 1 of Part I and complete the User Manual in order.
- **Want to get hands-on quickly**: jump to Chapter 2 (web) or Chapter 3 (desktop), finish a first task, then fill in the rest.
- **Looking for practical cases**: go directly to Part II or Part III and pick an area of interest.
- **Want to level up**: read Part IV for methodology and Skill deep-dives.
- **Looking for more**: all parts are continuously updated — watch this repository for updates.
...
Thanks to the authors who created and maintain the upstream QwenWork Greenbook ([wangxiaoshuai1998/QwenWorkGuide](https://github.com/wangxiaoshuai1998/QwenWorkGuide)). Click the card to view the full-size image and scan its QR code.
